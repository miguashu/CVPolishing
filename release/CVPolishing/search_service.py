    ...
    for qi, q in enumerate(queries):
        ...
        for i, item in enumerate(fetch_items):
            ...
            if url and url not in seen_urls:
                ...
                item["body"] = ""
    _SEARCH_CACHE[job_title] = (time.time(), gathered)
